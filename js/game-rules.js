export const GAME_RULES = {
  ...
  minesweeper: {
    ...
    html: `
      <section>
        <h3>目標</h3>
        <p>在不踩到地雷的情況下，翻開所有不含地雷的格子即獲勝；踩到地雷則遊戲結束。</p>
      </section>
      <section>
        <h3>操作</h3>
        <ul>
          <li>點擊格子翻開；數字代表周圍 8 格中的地雷數量。</li>
          <li>右鍵（或開啟「插旗模式」後點擊）可在格子插旗標記疑似地雷。</li>
          <li>點擊已翻開的數字格：若周圍插旗數已等於該數字，會自動翻開其餘未翻開的鄰格（連鎖翻旗）。</li>
        </ul>
      </section>
      <section>
        <h3>難度</h3>
        <p>初級（9×9 · 10 雷）、中級（16×16 · 40 雷）、高級（16×30 · 99 雷）。第一次點擊保證安全，不會直接踩雷。</p>
      </section>
    `,
  },
};
